    ...
    <div class="py-10">
      <header>
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold leading-tight tracking-tight text-gray-900">Edit event settings</h1>
        </div>
      </header>
      <main>
...
import BaseEventGuests from '../components/UI/BaseEventGuests.vue'
import {
    Dialog,
    DialogPanel,
    DialogTitle,
